...
ClapTrap::ClapTrap() : m_name("Default"), m_hitPoint(100), m_energyPoint(10), m_attackDamage(0)
{
	std::cout << m_name << ": " GREEN "Default Constructor called of ClapTrap" CLEAR << std::endl;
}

ClapTrap::ClapTrap(const ClapTrap& other) : m_name(other.m_name), m_hitPoint(other.m_hitPoint)
...
ClapTrap::ClapTrap(const std::string& name) : m_name(name), m_hitPoint(100), m_energyPoint(10), m_attackDamage(0)
{
